...
Erweitern Sie im **Projektmappen-Explorer**das **GraphTutorial** -Projekt, und klicken Sie mit der rechten Maustaste auf den Ordner **Modelle** . Wählen Sie **>-Klasse hinzufügen...**. Nennen Sie die `OAuthSettings` Klasse, und wählen Sie **Hinzufügen**aus. Öffnen Sie die Datei **OAuthSettings.cs** , und ersetzen Sie den Inhalt durch Folgendes.
